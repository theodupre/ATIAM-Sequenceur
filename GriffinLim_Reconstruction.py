...
from src.griffin_lim import GriffinLim_Methods
...
def run_demo():
    ...
    parser.add_argument('-i', '--in_file', type=str, default="bkvhi.wav",
                        help='Input WAV file')
    ...
    # converted to mono.
    input_signal = GriffinLim_Methods.get_signal(in_file, expected_fs=args.sample_rate_hz)
    ...
    stft_full = GriffinLim_Methods.stft_for_reconstruction(input_signal,
    ...
    if args.enable_mel_scale:
        ...
        filterbank = GriffinLim_Methods.make_mel_filterbank(min_freq_hz, max_freq_hz, mel_bin_count,
    ...
    x_reconstruct = GriffinLim_Methods.reconstruct_signal_griffin_lim(stft_modified_scaled,
                                                                   args.fft_size, hopsamp,
                                                                   args.iterations)
    ...
    GriffinLim_Methods.save_audio_to_file(x_reconstruct, args.sample_rate_hz)
